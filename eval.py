...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_dir', type=str, default='E:\datasets\cifar10')
    parser.add_argument('--norm', type=str, default='L2')#Linf L2
    parser.add_argument('--epsilon', type=float, default=8./255.)
    # parser.add_argument('--model', type=str, default='./result/resnet_56/1/model_best.pth.tar', 
    ...
    if args.resume:
        ...
        ckpt = torch.load('./pretrained/9433res56.pt', map_location='cuda:0', weights_only=True)
        model.load_state_dict(ckpt)
    ...
    if args.LT:
        testset = cifar10Imbanlance.Cifar10Imbanlance(imbanlance_rate=0.01, train=True, transform=transform_test,file_path=args.data_dir)
        print("load cifar10-LT\n")
    else:
