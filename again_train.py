...
parser.add_argument(
    ...
    type=str,
    default='[0.]*57',
    help='sparsity of each conv layer, 56-[0.]*30,110-[0.]*57')
...
def main():
    ...
    while epoch < args.epochs:
        ...
        if valid_top1_acc > best_top1_acc:
            ...
            is_best = True
            torch.save(model.state_dict(), './pretrained/100res110.pt')
    ...
    # # load attack    
    # net = eval(args.arch)(sparsity=sparsity).cuda()
    # net.load_state_dict(torch.load("./result/res56.pt"))
    # net.cuda()
    # net.eval()
    # from autoattack import AutoAttack
    # adversary = AutoAttack(net, norm=args.norm, eps=args.epsilon, log_path=args.log_path,
